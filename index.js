...
const config = {
    A187: '🔥RAMA🔥',
    instagram: 'riska_gaming',
    nomer: 'wa.me/+62895355566000',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCriZvQt4H2yjnbWG05We7lQ',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready, subscribe RISKA GAMING`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig:@riska_gaming._.ig`)
})
